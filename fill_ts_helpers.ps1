...
#   1. Проза: простая позиция 4–5 предл., сложная — от 5 предл.; без «Тип», «Назначение», «Модель» в списке.
#   2. Все важные цифры обязательны: из руководства, из Name (дублировать в списке), из реестра/достоверных источников.
#   3. Не повторять наименование основной техники в тексте каждой позиции; идентификатор — в Name.
